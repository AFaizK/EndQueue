    ...
    <div class="row m-2">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <form action="" method="" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            <label for="pre" class="col-sm-3 col-form-label">Nama Role</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                    name="judul" id="judul" value="{{ old('judul') }}" placeholder="Nama Role"
                                    required autofocus>
                                @error('judul')
                ...
                <a href="{{ url('/user') }}"> <button class="btn btn-warning btn-simple m-2" style=" float: left;">
                        Kembali
                    </button></a>
            </div>
        </div>
