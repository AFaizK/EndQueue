...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" >
      <div class="container" >
        <a href="#" class="navbar-brand"><img src="../assets/images/endqueue.png" width="40px" height="40px" alt="">
        <span style="color: #11BAED;">End</span>
        <span style="color: #035989;">queue</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarToggler">
          <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a href="endqueuebooking" class="nav-link">Booking</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">About Us</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">Instansi</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="features-icons-item mx-auto mb-5 mb-lg-3">
              ...
              <h3>Dimanapun dan Kapanpun</h3>

              <p class="lead mb-0">Bisa mengambil antrian dimana saja dan kapanpun</p>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="features-icons-item mx-auto mb-5 mb-lg-3">
              ...
              <p class="lead mb-0">Tidak perlu datang langsung untuk mengambil nomor antrian</p>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="features-icons-item mx-auto mb-5 mb-lg-3">
              ...
              <p class="lead mb-0">Aplikasi mudah digunakan untuk semua kalangan</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="showcase"> 
      <div class="container-fluid p-0">
        <div class="row g-0">
          <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('../assets/images/showcase-1.jpg');"></div>
        ...
        <div class="row g-0">
          <div class="col-lg-6 text-white showcase-img" style="background-image: url('../assets/images/showcase-2.jpg');"></div>
        ...
        <div class="row g-0">
          <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('../assets/images/showcase-3.jpg');"></div>
          <div class="col-lg-6 order-lg-1 my-auto showcase-text">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="testimonials-item mx-auto mb-5 mb-lg-0">
              <img src="../assets/images/testimonials-1.jpg" class="img-fluid rounded-circle mb-3" alt="">
              <h5>Margeret E.</h5>
          ...
          <div class="col-lg-4">
            <div class="testimonials-item mx-auto mb-5 mb-lg-0">
              <img src="../assets/images/testimonials-2.jpg" class="img-fluid rounded-circle mb-3" alt="">
              <h5>Fred S.</h5>
          ...
          <div class="col-lg-4">
            <div class="testimonials-item mx-auto mb-5 mb-lg-0">
              <img src="../assets/images/testimonials-3.jpg" class="img-fluid rounded-circle mb-3" alt="">
              <h5>Sarah W.</h5>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            <p class="text-muted">&copy; endqueue 2023</p>
          </div>
        </div>
      </div>
    </footer>
